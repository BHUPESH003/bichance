...
const termsContent = `
[PASTE THE CONTENT FROM https://timeleft.com/terms-conditions/ HERE, replacing all 'Timeleft' with 'bichance']
`;
...
const TermsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center py-12 px-4 fade-in-up">
      <h1 className="text-4xl font-bold mb-8 text-red-600">Terms & Conditions</h1>
      <div className="max-w-3xl w-full bg-white rounded-lg shadow p-6 overflow-y-auto" style={{ maxHeight: '70vh' }}>
        {/* Replace this with parsed HTML if needed */}
        <pre className="whitespace-pre-wrap text-gray-700 hover:text-red-600 transition-colors duration-200 text-sm">{termsContent}</pre>
      </div>
